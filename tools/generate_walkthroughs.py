...
<body class="guide-page" data-title-en="{esc(guide.title_en)} | Chronoromancer Guides" data-title-zh="{esc(guide.title_zh)} | Chronoromancer 官方攻略">
  ...
  <main id="content">
    <section class="guide-masthead"><div class="container">
      ...
      <div class="guide-meta"><span data-copy-en="{esc(category['en'])}" data-copy-zh="{esc(category['zh'])}">{esc(category['en'])}</span><span data-copy-en="{translation_label_en}" data-copy-zh="{translation_label_zh}">{translation_label_en}</span><span data-site-version>V0.9.7.5c</span></div>
    </div></section>
